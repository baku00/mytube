          ...
          @foreach ($likes as $index => $like)
            <div class="card c">
              <div class="card-body d-flex">
                <div class="c-img">
                  <img src="{{$like->video->miniature}}" alt="{{$like->video->miniature}}">
                </div>
                <div class="c-info">
                  <div class="title">
                    <h3><a href="">{{$like->video->title}}</a></h3>
                  </div>
                  <div class="c-content">
                    <p>{{$like->content}}</p>
                  </div>
                  <div class="d-flex">
                    <div class="c-likes">
                      ...
                      <span class="c-likes-number">{{count($like->video->likes)}}</span>
                    </div>
                    <div class="c-likes">
                    ...
                    <div class="c-dislikes">
                      ...
                      <span class="c-dislikes-number">{{count($like->video->dislikes)}}</span>
                    </div>
                  </div>
                  <a href="{{route('video.show',$like->video->id)}}">Accéder à la vidéo</a>
                </div>
              </div>
            </div>
          @endforeach
