          ...
          @foreach ($subscribers as $index => $subscriber)
            <div class="card a">
              <div class="card-body d-flex">
                ...
                <div class="a-info">
                  <div class="title">
                    <h3><a href="">{{$subscriber->user->name}}</a></h3>
                  </div>
                  ...
                  <div class="d-flex">
                    <div class="a-subscribers">
                      ...
                      <span class="a-subscribers-number">{{count($subscriber->user->subscribers)}}</span>
                    </div>
                    <div class="a-likes">
                      @include('includes.icons.like',['liked'=>false])
                      <span class="a-likes-number">{{count($subscriber->user->likes)}}</span>
                    </div>
                    <div class="a-dislikes">
                      @include('includes.icons.dislike',['disliked'=>false])
                      <span class="a-dislikes-number">{{count($subscriber->user->dislikes)}}</span>
                    </div>
                  </div>
                  <a href="{{route('creator.show',$subscriber->user->id)}}">Voir la chaine</a>
                </div>
              </div>
            </div>
          @endforeach
